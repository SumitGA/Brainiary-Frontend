  ...
  void submit() async {
    ...
    try {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => ResumeResultScreen(resume: result),
        ),
      );
    } catch (e) {
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            TextField(controller: experienceController, decoration: const InputDecoration(labelText: "Experience (semicolon separated)")),
            TextField(controller: skillsController, decoration: const InputDecoration(labelText: "Skills (comma separated)")),
            TextField(controller: educationController, decoration: const InputDecoration(labelText: "Education (semicolon separated)")),
            const SizedBox(height: 16),
            ElevatedButton(
              onPressed: isLoading ? null : submit,
              child: isLoading ? const CircularProgressIndicator() : const Text("Generate"),
            ),
          ],
        ),
      ),
